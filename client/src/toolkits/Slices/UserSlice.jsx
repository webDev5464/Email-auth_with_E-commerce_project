...
const Slice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(ResendnewOtp.pending, (state) => {
        state.userLoading = true;
      })
      .addCase(ResendnewOtp.fulfilled, (state, action) => {
        const { message, process } = action.payload;
        state.userLoading = false;
        toast.success(message);
      })
      .addCase(ResendnewOtp.rejected, (state, action) => {
        const { message, process } = action.payload;
        state.userLoading = false;
        toast.error(message);
      });
...
export const { RegisterProcessHandler, OtpCancelButton, OtpProcessHandler } =
  Slice.actions;
